...
pkgs.vscode-utils.buildVscodeMarketplaceExtension {
  ...
  meta = {
    changelog = "https://marketplace.visualstudio.com/items/jkiviluoto.tws/changelog";
    description = "Highlight and remove trailing whitespaces the right way!";
    downloadPage = "https://marketplace.visualstudio.com/items?itemName=jkiviluoto.tws";
